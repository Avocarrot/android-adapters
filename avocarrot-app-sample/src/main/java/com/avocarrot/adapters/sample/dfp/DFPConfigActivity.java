...
public class DFPConfigActivity extends AppCompatActivity {
    @NonNull
    ...
    public static Intent buildIntent(@NonNull final Context context, @ScreenAdType final int adTypeScreen, @NonNull final String defAdUnitId) {
        return new Intent(context, DFPConfigActivity.class).putExtra(EXTRA_AD_TYPE, adTypeScreen).putExtra(EXTRA_AD_UNIT_ID, defAdUnitId);
    }

    @Override
    protected void onCreate(final Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dfp_config);
    ...
    private void attempt(final int adTypeScreen) {
        ...
        if (TextUtils.isEmpty(adUnitId)) {
            ...
            IntentStarter.startDFPAdTypeActivity(this, adTypeScreen, adUnitId);
            finish();
        }
    }
}

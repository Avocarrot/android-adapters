...
public class AdmobActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(@NonNull final AdapterView<?> parent, @NonNull final View view, final int position, final long id) {
        switch (position) {
            case 0:
                IntentStarter.startAdmobConfigActivity(this, IntentStarter.SCREEN_NATIVE);
                break;
            case 1:
                IntentStarter.startAdmobConfigActivity(this, IntentStarter.SCREEN_BANNER);
                break;
            case 2:
                IntentStarter.startAdmobConfigActivity(this, IntentStarter.SCREEN_INTERSTITIAL);
                break;
            default:
    ...
    private static final class MainAdapter extends ArrayAdapter<String> {
        ...
        private MainAdapter(@NonNull final Context context) {
            super(context, android.R.layout.simple_list_item_1, android.R.id.text1, context.getResources().getStringArray(R.array.adbmob_ad_types));
        }
    }
}

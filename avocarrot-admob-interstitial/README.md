# Avocarrot Interstitial Ads Adapter for AdMob and DFP Android SDK
...
dependencies {
  compile 'com.avocarrot.sdk:adapter-admob-interstitial:1.4.4'
}
```
